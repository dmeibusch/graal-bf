...
/**
 * BF does not need a sophisticated error checking and reporting mechanism, so all unexpected
    ...
    public static Throwable fillInSLStackTrace(Throwable t) {
        ...
        Truffle.getRuntime().iterateFrames(new FrameInstanceVisitor<Void>() {
            public Void visitFrame(FrameInstance frame) {
                ...
                if (root instanceof BFEvalRootNode) {
                    methodName = ((BFEvalRootNode) root).getName();
                }

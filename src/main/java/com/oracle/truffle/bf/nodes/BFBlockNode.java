...
@NodeInfo(language = "BF", description = "Sequence of instruction nodes")
public class BFBlockNode extends Node {
    /**
     ...
     */
    @Children
    private final BFStatementNode[] bodyNodes;

    public BFBlockNode(BFStatementNode[] bodyNodes) {
    ...
    public void executeVoid(VirtualFrame frame) {
        for (BFStatementNode statement : bodyNodes) {
